...
class SignatureTest(unittest.TestCase):
    ...
    def test_sign_different_key(self):
        ...
        message = b"je moeder"
        signature = pkcs1.sign(message, self.priv, "SHA-256")
        original_e = self.pub.e
        wrong_e = 3 if original_e != 3 else 65537
        wrong_pub = rsa.PublicKey(self.pub.n, wrong_e)
        self.assertRaises(pkcs1.VerificationError, pkcs1.verify, message, signature, wrong_pub)
