...
class TestPSO(unittest.TestCase):
    ...
    def test_evaluate(self):
        ...
        """
        # Create a particle
        particle = pso_simple.Particle([1, 3])
        ...
        self.assertEqual(particle.pos_best_i, [1, 3])
        self.assertEqual(particle.err_best_i, 4)
    ...
    def test_update_velocity(self):
        ...
        particle.pos_best_i = [4, 5]

        # Set the particle's current position
        particle.position_i = [3, 4]

        # Set the particle's velocity
        particle.velocity_i = [0.2, 0.2]
        ...
        self.assertNotEqual(particle.velocity_i, [0.2, 0.2])
    ...
    def test_update_position(self):
        ...
        self.assertEqual(particle.position_i, [3.2, 4.2])
